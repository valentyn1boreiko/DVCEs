...
def wide_resnet50_3(pretrained=False, progress=True, **kwargs):
    ...
    return _resnet(
        "wide_resnet50_3", Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs
    )
...
def wide_resnet50_4(pretrained=False, progress=True, **kwargs):
    ...
    return _resnet(
        "wide_resnet50_4", Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs
    )
...
def wide_resnet50_5(pretrained=False, progress=True, **kwargs):
    ...
    return _resnet(
        "wide_resnet50_5", Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs
    )
...
def wide_resnet50_6(pretrained=False, progress=True, **kwargs):
    ...
    return _resnet(
        "wide_resnet50_6", Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs
    )
